        ...
        def __remind_list_update(user):
            ...
            def remind_list_update_main(week, course_list, count=0):
                ...
                if remind_list:
                    ...
                    user.remind_list = str(remind_list)
                    user.save()
                else:
                    return remind_list_update_main(week, course_list, count + 1)
    ...
    def show_course_list(self, now_user, nick_name, is_pic=True, is_with_num=False):
        ...
        try:
            ...
            if is_pic:
                ...
                temp_course_list.sort(key=lambda x: self.__get_course_time(x[2], x[3][0]))
                if not is_with_num:
                    msg = '\n'.join(['{}, {}, {}, 第{}节'.format(
