...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({}, __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_6_vuex__["a" /* mapMutations */])(['friend_list_change', 'friend_update_last', 'friend_history_update', 'add_chat_record', 'unread_zero', 'unread_add_one']), __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_6_vuex__["b" /* mapActions */])(['friend_list_update']), {
        back: function back() {
        ...
        select_func: function select_func(name) {
            ...
            if (!this.now_user.update) {
                __WEBPACK_IMPORTED_MODULE_5_jquery___default.a.post('/helper/chat/history/', { user: name }, function (data) {
                    if (data.res) {
...
var mutations = {
    ...
    friend_history_update: function friend_history_update(state, name) {
...
//# sourceMappingURL=app.5065012747e3c9d13ebf.js.map